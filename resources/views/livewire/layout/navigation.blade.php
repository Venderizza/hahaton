...
<nav x-data="{ open: false }" class="sidebar flex flex-col justify-between bg-white shadow-md fixed h-screen">
    <!-- Primary Navigation Menu -->
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col justify-between sm:h-[95vh] mt-5">
            <div class="flex flex-col">
                <!-- Logo -->
                <div id="logo" class="flex mb-10 gap-x-3 items-center justify-center">
                    ...
                    <span class="font-bold hidden sm:block text-2xl text-[#383435]" id="logo-text">escape</span>
                </div>
